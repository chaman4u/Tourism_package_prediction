...
# Assuming ProdTaken=0 is the majority class and ProdTaken=1 is the minority class
...
joblib.dump(best_model, "deployment/best_tourism_purchase_model_v1.joblib")
print("Model saved to deployment/best_tourism_purchase_model_v1.joblib")
